...
typedef struct fat_fs_struct fat_fs_struct;
typedef struct fat_file_struct fat_file_struct;
typedef struct fat_dir_struct fat_dir_struct;

/**
 * \ingroup fat_file
 * Describes a directory entry.
 */
typedef struct fat_dir_entry_struct
{
