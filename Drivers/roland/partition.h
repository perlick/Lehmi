 ...
 */
typedef uint8_t (*device_read_t)(void* context, offset_t offset, uint8_t* buffer, uintptr_t length);
/**
 ...
 * \see device_read_t
 */
typedef uint8_t (*device_read_interval_t)(void* context, offset_t offset, uint8_t* buffer, uintptr_t interval, uintptr_t length, device_read_callback_t callback, void* p);
/**
 ...
 */
typedef uint8_t (*device_write_t)(void* context, offset_t offset, const uint8_t* buffer, uintptr_t length);
/**
 ...
 * \see device_write_t
 */
typedef uint8_t (*device_write_interval_t)(void* context, offset_t offset, uint8_t* buffer, uintptr_t length, device_write_callback_t callback, void* p);
...
typedef struct partition_struct
{
    ...
    /**
     * Centext to be used in with device functions
    */
    void* context;
